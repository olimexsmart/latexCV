...
\vspace*{3.49cm} % start 8 cm from the top of the page}
    ...
    \vspace*{1.2cm} % text starts 1cm under the top of the minipage
        ...
        \node{\faMapMarker}; 
        & \node{Rupinaro \\ 16043 Chiavari (GE), Italy};\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% MAIN SECTION %%%%%%%%%%%%%%%%%%%%
    \adjustbox{valign=t}{\begin{minipage}{11.4cm}
        \vspace*{1cm}
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % Work Experience
        ...
        \MySection{2018-Ongoing}{Ship.png}{Master Degree}{UNIGE}{Genoa, Italia}{Faculty}{A description of your piracy. \\\textbf{Degree: 110/110 cum laude}}
