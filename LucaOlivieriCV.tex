...
\vspace*{1.2cm} % text starts 1cm under the top of the minipage
	...
	and with personal projects, tech-related or not. Programming is my first interest, while electronics is the second one, 
    preferably digital than analog. My core values are respecting my work and the people I work with.  
	% Contact
    ...
    [
        ...
        \node{\faQrcode}; & \node{\href{https://sagrapos.it}{sagrapos.it}};\\
	};
	\end{tikzpicture}
    % QR Code
    \begin{center}
    ...
    \begin{center}
        \cvTag{C}\cvTag{Angular}\cvTag{React}\cvTag{Python}\cvTag{C\#}\cvTag{Git}
		\cvTag{CAD (basic)}\cvTag{\LaTeX}\cvTag{MatLab}
    \end{center}
	% Languages
...
\adjustbox{valign=t}{\begin{minipage}{11.3cm}
    ...
    \vspace*{0.22cm}
	\workSection{2023-now}{Senior Software Engineer}{Genova}{Freelance}
	{
		Worked for multiple clients delivering projects using a number of different technologies. 
        These ranges from mobile apps for both Android and iOS, web apps, firmware projects, server deployment and managing for small teams. Worked on an industrial tool in C\# for streamlining product design and testing for a steel mill. Developed SagraPOS, a desktop application used in small food fairs and events for ticket printing. 
	}   
...
\adjustbox{valign=t}{
    ...
    \vspace*{0.4cm} 
        ...
        \vspace*{-0.5cm}
        \begin{center}
            \cvTag{Rust}\cvTag{Embedded Linux}
...
\begin{minipage}{11.3cm}
    ...
    \personalProject{SagraPOS}
    {
        Most local culinary events have the need of a low cost 
        and simple POS system. 
        
        I've built a desktop app in Electron that interfaces with thermal printers that is designed to be easily deployed and used. 

        It has been successfully used in numerous local events since 2021. 
    }
	
    \vspace*{0.22cm}
    \personalProject{Proselide\\\textit{a startup}}
    {
        I challenged myself to launch an idea and start a business. 
    ...
    \personalProject{Self Door Opener}
    {
        ...
        This allows guests to enter by themselves or enables owners to simply 
    ...
    \personalProject{Boat Tracker}
    {
        ...
        Data is sent to a server using cellular service. 
    ...
    {
        An embedded system that connects through BT to an OBD2 interface and displays information about the state of the engine.
    }	
